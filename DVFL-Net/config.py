...
_C.KD.BETA = 0.3
_C.KD.GAMMA = 0.5
_C.KD.TEMPERATURE = 10

# Teacher Model Settings
_C.TEACHER_MODEL = CN()
_C.TEACHER_MODEL.TYPE = 'focal'
_C.TEACHER_MODEL.NAME = ''
_C.TEACHER_MODEL.RESUME = ''
_C.TEACHER_MODEL.NUM_CLASSES = 1000
_C.TEACHER_MODEL.DROP_RATE = 0.0
_C.TEACHER_MODEL.DROP_PATH_RATE = 0.1
_C.TEACHER_MODEL.LABEL_SMOOTHING = 0.1
_C.TEACHER_MODEL.PRETRAINED = False
_C.TEACHER_MODEL.SPEC = CN(new_allowed=True)
_C.TEACHER_MODEL.PRETRAINED_PATH = ''

# FocalNet parameters
_C.TEACHER_MODEL.FOCAL = CN()
_C.TEACHER_MODEL.FOCAL.PATCH_SIZE = 4
_C.TEACHER_MODEL.FOCAL.IN_CHANS = 3
_C.TEACHER_MODEL.FOCAL.EMBED_DIM = 128
_C.TEACHER_MODEL.FOCAL.DEPTHS = [2, 2, 18, 2]
_C.TEACHER_MODEL.FOCAL.MLP_RATIO = 4.
_C.TEACHER_MODEL.FOCAL.PATCH_NORM = True
_C.TEACHER_MODEL.FOCAL.FOCAL_LEVELS = [2, 2, 2, 2]
_C.TEACHER_MODEL.FOCAL.FOCAL_WINDOWS = [3, 3, 3, 3]
_C.TEACHER_MODEL.FOCAL.FOCAL_FACTORS = [2, 2, 2, 2]
_C.TEACHER_MODEL.FOCAL.USE_CONV_EMBED = False
_C.TEACHER_MODEL.FOCAL.USE_LAYERSCALE = False
_C.TEACHER_MODEL.FOCAL.USE_POSTLN = False
_C.TEACHER_MODEL.FOCAL.USE_POSTLN_IN_MODULATION = False
_C.TEACHER_MODEL.FOCAL.NORMALIZE_MODULATOR = False
_C.TEACHER_MODEL.FOCAL.PRETRAINED_PATH = ''

_C.TEACHER_MODEL.TUBELET_SIZE = 1
# -----------------------------------------------------------------------------
# Misc
# -----------------------------------------------------------------------------
...
def update_config(config, args):
    ...
    config.LOCAL_RANK = int(os.environ['LOCAL_RANK']) # resolved 
